      <div id="" class="row">
          ...
          <div class="col-md-2">
            ...
            <div class="block-100"></div>
            <p>
              <a href="#" class="nav-link" id="link-platforma">Платформа</a><br>
              <a href="#" class="nav-link" id="link-tasks">Цели и задачи</a><br>
              <a href="#" class="nav-link" id="link-actions">Направление деятельности</a><br>
              <a href="#" class="nav-link" id="link-leaders">Руководство</a><br>
              <a href="#" class="nav-link" id="link-bank">JBIK Bank</a>
            </p>
            <script>
            	// First run
